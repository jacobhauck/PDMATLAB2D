...
if ~exist("GridFile1-oblique.mat", "file")
    sim.GenerateGrid(Xo, Xn, Yo, Yn, 200, 200, false);
    sim.SaveGrid("GridFile1-oblique.mat");
else
    sim.LoadGrid("GridFile1-oblique.mat");
end
...
sim.DynamicPlotFrequency = 20;
sim.videoFrameRate = 20;
sim.OutputName = 'WaveOblique';
